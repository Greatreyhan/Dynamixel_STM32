...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	/******************* TEST COMMAND *********************/
	uint8_t setID[8] = {0xFF, 0xFF, 0xFE, 0x04, 0x03, 0x03, 0x01,0xF6};
	...
	uint8_t LED_and_move[9] = {0xFF, 0xFF, 0x00, 0x05, 0x03, 0x18, 0x01, 0x01, 0xDD}; // 6 byte feedback
	uint8_t LED_and_move_broadcast[9] = {0xFF, 0xFF, 0xFE, 0x05, 0x03, 0x18, 0x01, 0x01, 0xDF}; // 6 byte feedback
	
	/******************* TRANSMIT DATA ********************/
	HAL_HalfDuplex_EnableTransmitter(&huart2);
	HAL_UART_Transmit(&huart2, LED_and_move_broadcast, 9, 10);
